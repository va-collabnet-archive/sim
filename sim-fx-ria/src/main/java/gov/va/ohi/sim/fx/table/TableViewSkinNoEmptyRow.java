...
public class TableViewSkinNoEmptyRow<T> extends VirtualContainerBaseNoEmptyRow<TableView<T>, TableViewBehavior<T>, TableRow<T>> {

    public TableViewSkinNoEmptyRow(final TableView tableView) {
        super(tableView, new TableViewBehavior(tableView));

        // init the VirtualFlow
        flow = new VirtualFlowNoEmptyRow();
        flow.setPannable(false);
        flow.setFocusTraversable(getSkinnable().isFocusTraversable());
        flow.setCreateCell(new Callback<VirtualFlowNoEmptyRow, TableRow>() {
            @Override public TableRow call(VirtualFlowNoEmptyRow flow) {
                return TableViewSkinNoEmptyRow.this.createCell();
            }
        });
        ...
        tableHeaderRow = new TableHeaderRowNoEmptyRow(tableView, flow);
