 ...
 * @profile common
 */
public abstract class VirtualContainerBaseNoEmptyRow<C extends Control, B extends BehaviorBase<C>, I extends IndexedCell> extends SkinBase<C, B> {

    public static final String SCROLL_TO_INDEX = "VirtualContainerBase.scrollToIndex";

    public VirtualContainerBaseNoEmptyRow(C control, B behavior) {
     ...
     * all the cells.
     */
    protected VirtualFlowNoEmptyRow flow;
