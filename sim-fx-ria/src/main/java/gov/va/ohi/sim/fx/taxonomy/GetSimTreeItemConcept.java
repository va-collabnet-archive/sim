...
class GetSimTreeItemConcept implements Callable<Boolean> {
    ...
    RelationshipPolicy relationshipPolicy = RelationshipPolicy.ORIGINATING_AND_DESTINATION_TAXONOMY_RELATIONSHIPS;
    ...
    public Boolean call() throws Exception {
        ...
        concept = RestClient.getRestClient().getFxConcept(
                reference,
