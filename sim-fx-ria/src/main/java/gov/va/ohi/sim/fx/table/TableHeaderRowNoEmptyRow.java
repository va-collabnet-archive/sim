 ...
 */
class TableHeaderRowNoEmptyRow extends StackPane {
    
    private static final String MENU_SEPARATOR = 
            ControlResources.getString("TableView.nestedColumnControlMenuSeparator");
    
    private final VirtualFlowNoEmptyRow flow;
    VirtualFlowNoEmptyRow getVirtualFlow() { return flow; }
    ...
    private BooleanProperty reorderingProperty = new BooleanPropertyBase() {
        @Override protected void invalidated() {
            TableColumnHeaderNoEmptyRow r = getReorderingRegion();
            if (r != null) {
        ...
        public Object getBean() {
            return TableHeaderRowNoEmptyRow.this;
        }
    ...
    private TableColumnHeaderNoEmptyRow reorderingRegion;
    public TableColumnHeaderNoEmptyRow getReorderingRegion() { return reorderingRegion; }

    public void setReorderingColumn(TableColumn rc) {
        dragHeaderLabel.setText(rc == null ? "" : rc.getText());
    }

    public void setReorderingRegion(TableColumnHeaderNoEmptyRow reorderingRegion) {
     ...
     * at that level.
     */
    private final NestedTableColumnHeaderNoEmptyRow header;
    ...
    public TableHeaderRowNoEmptyRow(final TableView<?> table, final VirtualFlowNoEmptyRow flow) {
        this.table = table;
        this.flow = flow;
        ...
        header = new NestedTableColumnHeaderNoEmptyRow(table, null);
