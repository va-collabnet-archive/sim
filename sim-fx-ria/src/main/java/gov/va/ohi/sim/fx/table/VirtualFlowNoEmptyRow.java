 ...
 */
public class VirtualFlowNoEmptyRow extends Region {
    /**
        ...
        if (vertical == null) {
            vertical = new BooleanPropertyBase(true) {
                ...
                public Object getBean() {
                    return VirtualFlowNoEmptyRow.this;
                }
    ...
    public void setCellCount(int i) {
        ...
        // cell count.
        if (countChanged) {
            VirtualScrollBarNoEmptyRow lengthBar = isVertical() ? vbar : hbar;
            lengthBar.setMax(i);
        }
     ...
     */
    private Callback<VirtualFlowNoEmptyRow, ? extends IndexedCell> createCell;
    public Callback<VirtualFlowNoEmptyRow, ? extends IndexedCell> getCreateCell() { return createCell; }
    protected void setCreateCell(Callback<VirtualFlowNoEmptyRow, ? extends IndexedCell> cc) {
        this.createCell = cc;
...
//    private boolean layingOut = false;
     ...
     * ONLY for testing.
     */
    private VirtualScrollBarNoEmptyRow hbar = new VirtualScrollBarNoEmptyRow(this);

    final VirtualScrollBarNoEmptyRow getHbar() {
        return hbar;
    }
    /**
     ...
     * ONLY for testing.
     */
    private VirtualScrollBarNoEmptyRow vbar = new VirtualScrollBarNoEmptyRow(this);

    final VirtualScrollBarNoEmptyRow getVbar() {
        return vbar;
    }
...
//        layingOut = false;
    ...
    private void updateViewport() {
        ...
        VirtualScrollBarNoEmptyRow breadthBar = isVertical() ? hbar : vbar;
        VirtualScrollBarNoEmptyRow lengthBar = isVertical() ? vbar : hbar;
...
//        layingOut = false;
    ...
    static class ClippedContainer extends Region {
        private VirtualFlowNoEmptyRow flow;
        ...
        public ClippedContainer(final VirtualFlowNoEmptyRow flow) {
            if (flow == null) {
