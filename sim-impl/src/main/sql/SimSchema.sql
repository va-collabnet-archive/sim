...
CREATE TABLE DOCUMENTS  ( 
	...
	PROVIDERNID	INTEGER NOT NULL,
	INID       	INTEGER NOT NULL,
        INST_NAME       VARCHAR(128),
        INST_NUMBER     VARCHAR(36),
	PRIMARY KEY(DNID)
);
...
CREATE TABLE PERSONS  ( 
	...
	PNID     	INTEGER GENERATED ALWAYS AS IDENTITY,
        PIEN            VARCHAR(36),
        ID_IDENTITY     VARCHAR(36),
        ID_ASSN_FAC     VARCHAR(36),
        ID_ASSN_AUTH    VARCHAR(36),
	NAME_PREFIX 	VARCHAR(10),
	NAME_GIVEN 	VARCHAR(128) NOT NULL,
	NAME_MIDDLE 	VARCHAR(128),
	NAME_FAMILY 	VARCHAR(128) NOT NULL,
